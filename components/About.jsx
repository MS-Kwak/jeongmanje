        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-foreground mb-6 leading-tight">
              아직도 <span className="text-primary">정책자금</span><br />
              못 받으셨나요?
            </h2>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              매년 <span className="text-foreground font-semibold">20조 원</span> 이상 쏟아지는 정책자금과 지원금,
              대표님의 몫은 어디에 있습니까?
            </p>
            ...
            <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-6 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-foreground mb-2">자본 10억 기업 vs 1억 기업</h4>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    단순히 자금 규모만의 차이가 아닙니다.<br />
                    <span className="text-primary font-medium">지원받을 수 있는 정책자금을 아느냐, 모르느냐</span>의 차이입니다.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>아직도 개인 자금으로만 사업을 운영 중이신가요?</span>
            </motion.div>
          </motion.div>
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-primary/10 p-8 border border-border/50">
              ...
              <div className="space-y-4">
                {problems.map((problem, index) => (
                  ...
                  >
                    <CheckCircle2 className="w-5 h-5 text-muted-foreground group-hover:text-primary transition-colors flex-shrink-0 mt-0.5" />
              ...
              <motion.div
                ...
                className="mt-8 p-4 rounded-xl bg-gradient-to-r from-primary to-accent text-white text-center"
              >
                <p className="font-semibold">
                  하나라도 해당된다면,<br />
                  <span className="text-lg">전문 컨설팅이 답을 드릴 차례입니다.</span>
                </p>
              </motion.div>
            </div>
          </motion.div>
